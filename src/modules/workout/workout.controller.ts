...
export class WorkoutController {
  ...
  async createWorkout(@Body() createWorkoutDto: CreateWorkoutDto) {
    try {
      ...
      throw new HttpException(
        err.message || 'Failed to create workout',
        status,
      );
    }
  }
  ...
  async toggleExerciseTimer(
    ...
    try {
      const result = await this.workoutService.toggleExerciseTimer(
        workoutId,
        exerciseId,
        active,
      );
  ...
  async toggleExerciseSetTimer(
    ...
    try {
      const result = await this.workoutService.toggleExerciseSetTimer(
        workoutId,
        exerciseId,
        setId,
        active,
